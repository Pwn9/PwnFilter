...
public class FilterServiceImpl implements FilterService{
    ...
    private final PointManagerImpl pointManager = new PointManagerImpl(this);
    ...
    public FilterServiceImpl(Logger logger) {
        this.config = new FilterConfigImpl(logger);
        this.actionFactory = new ActionFactoryImpl(this);
        this.logger = logger;
    }

    public PointManagerImpl getPointManager() {
        return pointManager;
    }
