 ...
 * eg: "then kick" would return the Action kick object.
 *
 * @author Sage905
 * @version $Id: $Id
 */
public final class ActionFactoryImpl implements ActionFactory {
    ...
    public ActionFactoryImpl(FilterService filterServiceImpl) {
        // Ensure that all instances get the Core Actions
        actionTokens.add(CoreAction.class);
        filterConfig = filterServiceImpl.getConfig();
    }
    ...
    public Action getAction(String actionName, String actionData)
    ...
    public void addActionTokens(Class<? extends ActionToken> tokenEnum) {
