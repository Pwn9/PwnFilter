...
public class BaseCommandExecutor implements TabExecutor {
     ...
     *
     * @param instance a {@link PwnFilterPlugin} object.
     */
    public BaseCommandExecutor(PwnFilterPlugin instance){
        plugin = instance;
     ...
     * <p>addSubCommand.</p>
     *
     * @param subCommand a {@link com.pwn9.PwnFilter.bukkit.command.SubCommand} object.
     */
